...
public class Settings {
    ...
    private final ResourceBundle resourceBundle = ResourceBundle.getBundle("locale.settings");
    ...
    protected void initialize() {
        ...
        ResourceBundle settingsLocale = ResourceBundle.getBundle("locale.settings");
        ...
        if (Model.getInstance().settings.getVersion() == null) {
            ...
            versionContainer.getChildren().add(
                    new ImageView(
                            new Image(
                                    Objects.requireNonNull(getClass().getClassLoader().getResourceAsStream("img/tick.png")),
                                    20,
                                    20,
                                    true,
                                    true
