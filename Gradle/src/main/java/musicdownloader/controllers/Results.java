...
public class Results {
    ...
    private final ResourceBundle resourceBundle = ResourceBundle.getBundle("locale.results");
        ...
        root.getStylesheets().add(
                String.valueOf(
                        getClass().getClassLoader().getResource(
                                "css/" + (Model.getInstance().settings.getSettingBool("dark_theme") ? "dark" : "standard") + ".css"
                        )
                )
        );
    ...
    private void defaultView(String message) {
        ...
        ImageView iconImage = new ImageView(
                new Image(
                        Objects.requireNonNull(getClass().getClassLoader().getResourceAsStream("img/song_default.png")),
                        50,
                        50,
                        true,
                        true
            ...
            linkPart1.setOnMouseClicked(e -> {
                try {
                    FXMLLoader downloadsLoader = new FXMLLoader(
                            getClass().getClassLoader().getResource("fxml/downloads.fxml"),
                            ResourceBundle.getBundle("locale.downloads")
                    );
    ...
    class searchResult extends Result {
        ...
        protected class MediaController {
            ...
            private final ImageView playIcon = new ImageView(
                    new Image(
                            Objects.requireNonNull(getClass().getClassLoader().getResourceAsStream("img/play.png")),
                            20,
                            20,
                            true,
                            true
            ...
            private void play() {
                ...
                playIcon.setImage(
                        new Image(
                                Objects.requireNonNull(getClass().getClassLoader().getResourceAsStream("img/paused.png")),
                                20,
                                20,
                                true,
                                true
