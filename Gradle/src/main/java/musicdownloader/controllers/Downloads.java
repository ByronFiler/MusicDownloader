...
public class Downloads {
    ...
    private final ResourceBundle resourceBundle = ResourceBundle.getBundle("locale.downloads");
    ...
    private void initialize() {
        ...
        if (Model.getInstance().settings.getSettingBool("dark_theme")) {
            root.getStylesheets().add(String.valueOf(getClass().getClassLoader().getResource("css/dark.css")));
            albumViewSelector.setEffect(new ColorAdjust(0, 0, 1, 0));
            songViewSelector.setEffect(new ColorAdjust(0, 0, 1, 0));
        }

        else root.getStylesheets().add(String.valueOf(getClass().getClassLoader().getResource("css/standard.css")));
    ...
    public void searchView(Event event) {
        ...
        try {
            (
                    ...
                    .setRoot(
                            FXMLLoader.load(
                                    Objects.requireNonNull(getClass().getClassLoader().getResource("fxml/search.fxml")),
    ...
    private void defaultView() {
        ...
        ImageView iconImage = new ImageView(
                new Image(
                        Objects.requireNonNull(getClass().getClassLoader().getResourceAsStream("img/icon.png")),
                        50,
                        50,
                        true,
                        true
            ...
            public void markPaused() {
                ...
                if (progress < 1) {
                    ...
                    right.getChildren().setAll(
                            new ImageView(
                                    new Image(
                                            Objects.requireNonNull(getClass().getClassLoader().getResourceAsStream("img/warning.png")),
                                            24,
                                            24,
                                            true,
                                            true
                    ...
                    switch ((int) (progress * 10)) {
                        ...
                        case 10:
                            right.getChildren().setAll(
                                    new ImageView(
                                            new Image(
                                                    Objects.requireNonNull(getClass().getClassLoader().getResource("img/tick.png")).toURI().toString(),
                                                    25,
                                                    25,
                                                    true,
                                                    true
            ...
            public QueuedResult(String title, boolean isAlbum) throws JSONException {
                ...
                try {
                    ImageView scheduledIcon = new ImageView(
                            new Image(
                                    Objects.requireNonNull(getClass().getClassLoader().getResource("img/scheduled.png")).toURI().toString(),
                                    25,
                                    25,
                                    true,
                                    true
